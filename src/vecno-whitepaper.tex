...
\date{24/12/2025}
\author{
    {\small Whitepaper v.0.0.1 --- Written By \small \href{https://github.com/Vecno-Foundation}{Vecno Foundation Team}}
}
...
This allocation of the premine helps with growth, sustainability, and efficiency of the Vecno blockchain ecosystem. The following table outlines the structure of the Community Donation Offering. Participants donate USDT (Tether) to receive airdropped coins at the specified price tiers. The price per coin increases as each tier is filled, starting at \$0.020 for the first 1,500,000 coins and rising incrementally to \$0.190 for the final 500,000 coins.

\subsubsection{Important Notice on the Offering}

The Community Donation Offering (including the airdrop of VE tokens in exchange for USDT donations) is strictly a \textbf{private placement} and is \textbf{not an offer to the public}. 

Participation is limited to \textbf{fewer than 150 natural or legal persons per EEA Member State}, where such persons are acting on their own account. 

The Vecno Foundation reserves the right to reject any participation that would cause this limit to be exceeded in any Member State. This offering is invitation-only and not advertised or made available to the general public.
...
\midrule
1500000 & 0.020 & 30000.00 \\
500000  & 0.040 & 20000.00 \\
500000  & 0.050 & 25000.00 \\
250000  & 0.060 & 15000.00 \\
500000  & 0.070 & 35000.00 \\
1000000 & 0.080 & 80000.00 \\
500000  & 0.090 & 45000.00 \\
750000  & 0.100 & 75000.00 \\
...
\midrule
\textbf{10000000} & & \textbf{\$1000000.00} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item Total funds raised: \$1,000,000.00 (in USDT)
\end{itemize}

\vspace{0.5cm}

The majority of the funds raised through donations, totaling \$1,000,000.00 in USDT, is allocated to \textbf{listings and marketing}. \$60,000.00 will be dedicated to \textbf{operational costs} to support the project's ongoing activities and infrastructure.
